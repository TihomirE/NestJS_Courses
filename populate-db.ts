...
const MONGODB_CONNECTION_URL = 'mongodb+srv://tiho_nestjs_test:HxwRzS4cHT08kBFK@myclustertest01.99ims.mongodb.net/nestjs-udemy-course?retryWrites=true&w=majority';

// Database Name
const dbName = 'nestjs-udemy-course';
